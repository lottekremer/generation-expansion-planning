...
# Random.seed!(4861957) # This seed was used for the initial dataset creation
Random.seed!(123456) # This seed was used for the second dataset creation (test set)
...
rename!(demand, :time_step => :timestep)
rename!(generation_availability, :time_step => :timestep)
...
CSV.write("./case_studies/optimality/inputs_closemixed/demand.csv", demand_close_mixed)
CSV.write("./case_studies/optimality/inputs_closemixed/generation_availability.csv", generation_availability_close_mixed)
